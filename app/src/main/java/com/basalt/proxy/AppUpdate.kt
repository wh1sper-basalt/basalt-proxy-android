...
private const val UPDATE_LOG_TAG = "BasaltProxy"
private const val GITHUB_RELEASES_URL = "https://api.github.com/repos/wh1sper-basalt/basalt-proxy-android/releases?per_page=30"
private const val GITHUB_LATEST_RELEASE_URL = "https://api.github.com/repos/wh1sper-basalt/basalt-proxy-android/releases/latest"
private const val GITHUB_LATEST_RELEASE_WEB_URL = "https://github.com/wh1sper-basalt/basalt-proxy-android/releases/latest"
private const val GITHUB_RELEASE_TAG_URL_PREFIX = "https://github.com/wh1sper-basalt/basalt-proxy-android/releases/tag/"
private const val GITHUB_TAGS_URL = "https://api.github.com/repos/wh1sper-basalt/basalt-proxy-android/tags?per_page=100"
private const val GITHUB_TAG_TREE_URL_PREFIX = "https://github.com/wh1sper-basalt/basalt-proxy-android/tree/"
...
private fun fetchReleaseFromLatestWebRedirect(): AppReleaseInfo? {
    ...
    return try {
        ...
        conn.setRequestProperty("User-Agent", "BasaltProxyAndroid/${BuildConfig.VERSION_NAME}")
